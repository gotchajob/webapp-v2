...
import { Autocomplete, Box, Button, FormControlLabel, Grid, Pagination, Radio, RadioGroup, Stack, TextField, Typography } from "@mui/material";
        ...
        <>
            <Box
                ...
                <Stack
                    ...
                    <Typography variant="h1" sx={{ color: "#F3F5F7", fontFamily: 'Roboto, sans-serif' }}>Danh sách mẫu CV xin việc chuẩn 2024</Typography>
                    <Typography variant="h3" sx={{ color: "#F3F5F7", fontFamily: 'Roboto, sans-serif' }}>Các mẫu CV được thiết kế chuẩn theo từng ngành nghề.</Typography>
                    <Typography variant="h3" sx={{ color: "#F3F5F7", fontFamily: 'Roboto, sans-serif' }}>Phù hợp với cả sinh viên và người đi làm.</Typography>
                </Stack>
            </Box>

            <Box sx={{ paddingX: 20, paddingY: 2, backgroundColor: "#FEFDFC" }}>
                <Grid container justifyContent="space-between" spacing={2}>
                    <Grid item xs={12} sx={{ justifyContent: "flex-end" }}>
                        <Typography variant="body2" sx={{ fontFamily: 'Roboto, sans-serif', fontWeight: "bold", fontSize: 25, color: "#1E88E5" }}>
                            ...
                            <StyledLink href={`/create-cv/cv-template`}>
                                <SubCard sx={{ borderColor: PRIMARYCOLOR }}>
                                    <Stack
                                        ...
                                        <Image width={100} height={100} alt="image" src={"https://static.topcv.vn/v4/image/cv_builder/choose-cv-data/item/case.png"}></Image>
                                        {/* <WorkIcon sx={{ fontSize: 68, color: "#333333" }} /> */}
                                        <Typography variant="body2" sx={{ fontFamily: 'Roboto, sans-serif', fontWeight: "bold" }}>{item.job}</Typography>
                                        <Typography variant="h4" sx={{ fontFamily: 'Roboto, sans-serif', color: "#1E88E5" }}>{item.title}</Typography>
                                    </Stack>
                                </SubCard>
                            </StyledLink>
                        </Grid>

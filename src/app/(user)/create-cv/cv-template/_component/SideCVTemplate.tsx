...
const data = [
    ...
    { img: 'https://www.topcv.vn/images/cv/screenshots/thumbs/cv-template-thumbnails-v1.2/passion.png', title: 'Chuyên gia' },
            ...
            {data.map((template, index) => (
                <Grid item xs={6} key={index} onClick={() => handleChangeTemplate(index)}>
                    ...
                    >
                        ...
                        <Typography fontSize={16} align="center">{template.title}</Typography>
                    </Stack>
                </Grid>
            ))}
        </Grid>

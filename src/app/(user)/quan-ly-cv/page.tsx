...
import { Autocomplete, Avatar, Box, Button, CardContent, Divider, Grid, IconButton, InputAdornment, Stack, TextField, Typography } from "@mui/material";
...
const sortOptions = [
    { title: "CV tạo mới nhất" },
    { title: "CV tạo cũ nhất" }
];
